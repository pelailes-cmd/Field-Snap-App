...
import { Trash2, SortAsc, LayoutGrid, LayoutList, LogOut, Info, Send, ShieldCheck, HardHat, User, Check, ChevronDown, Wrench, Receipt, FileText, Activity, Package } from 'lucide-react';
    ...
    <div className="container" style={{ paddingBottom: '120px' }}>
      ...
      <div className="card" style={{ marginBottom: '1.5rem' }}>
        ...
        <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', marginBottom: '1rem' }}>
          FieldSnap is a comprehensive professional documentation and management tool designed for engineers, site inspectors, and property managers.
        </p>
        <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', marginBottom: '1.5rem' }}>
          Beyond site documentation, FieldSnap features integrated tools for <strong>Property and Facility Management</strong>, including utility billing, technical reporting, and asset inventory tracking.
        </p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '1.5rem' }}>
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
            ...
            <div><p style={{ fontWeight: '600', fontSize: '0.9rem' }}>Secure & Private</p><p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>All data stored locally on your device.</p></div>
          </div>
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
            <div style={{ background: 'rgba(40, 167, 69, 0.1)', padding: '0.5rem', borderRadius: '8px' }}><HardHat size={20} color="var(--success)" /></div>
            <div><p style={{ fontWeight: '600', fontSize: '0.9rem' }}>Professional Grade</p><p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>Standardized reporting and documentation.</p></div>
          </div>
        </div>

        <h4 style={{ marginBottom: '1rem', fontSize: '1rem' }}>Contact Developer</h4>
      ...
      <div style={{ textAlign: 'center', marginTop: '2rem', fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
        <p>Developer: <strong>Pel</strong></p>

...
import { Save, Edit3, X, Upload, Building2, Image } from 'lucide-react';
  ...
  return (
    <div className="container" style={{ paddingBottom: '100px' }}>
      ...
      <form onSubmit={handleSubmit} className="card">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', alignItems: 'center', marginBottom: '1.5rem' }}>
          <div style={{ position: 'relative' }}>
            <div style={{ 
              width: '100px', height: '100px', borderRadius: '20px', backgroundColor: 'var(--surface)', 
            ...
            {isEditing && (
              <label style={{ 
                position: 'absolute', bottom: '-10px', right: '-10px', backgroundColor: 'var(--primary)', 
                color: 'white', borderRadius: '50%', padding: '8px', cursor: 'pointer', boxShadow: '0 4px 10px rgba(0,0,0,0.1)' 
              }}>
                <Upload size={16} />
          ...
          <div style={{ textAlign: 'center' }}>
            <p style={{ fontSize: '0.875rem', fontWeight: '600', color: 'var(--text-secondary)' }}>Company Logo</p>
          </div>
        </div>

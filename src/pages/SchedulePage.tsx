...
import { Calendar, Clock, Trash2, CheckCircle2, Circle, PlayCircle, XCircle, LayoutList, Bell, FileText, Plus, ChevronLeft, Download, Image as ImageIcon, X, HardHat } from 'lucide-react';
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          ...
          <button 
            ...
            style={{ 
              ...
              border: '1px solid var(--border)', borderRadius: '12px', color: 'var(--text)', padding: '0.75rem',
              display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: 'bold', cursor: 'pointer'
            }}
            title="Technicians & Laborers"
          >
            <HardHat size={20} />
          </button>
          <button 

...
import { MonitoringChecklistPage } from './pages/MonitoringChecklistPage';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/monitoring-checklist/:monitoringId" element={<ProtectedRoute><MonitoringChecklistPage /></ProtectedRoute>} />
        <Route path="/inventory" element={<ProtectedRoute><InventoryPage /></ProtectedRoute>} />
        <Route path="/personnel" element={<ProtectedRoute><PersonnelPage /></ProtectedRoute>} />
        <Route path="/personnel-tasks/:personnelId" element={<ProtectedRoute><PersonnelTasksPage /></ProtectedRoute>} />
